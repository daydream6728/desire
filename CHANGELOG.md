...
matching a marker as the whole last line, as the label of an HTTPS Markdown link, or inside that
link's target, and never in prose; `answered` reads it. `AGENTS.md` says an agent signs with its
